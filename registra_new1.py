...
class IPCamVideoAlarm():
    def __init__(self, sorgente, cartella, nome_cam, ruota=0.0, mog2=False):
        ...
        # RECORDING 
        self.recording = IPCamVideoAlarm_Recording(cartella, nome_cam, self.height, self.width)
...
if __name__=="__main__":
    ...
    video_path = 'rtsp://admin:luca2006@79.37.38.2/Streaming/Channels/102'
    video_store = "C:\opencv\Registrazioni"

    cam1 = IPCamVideoAlarm(video_path, video_store, "Cam1", 90.0, False)
    ...
    while True:
            ...
            cam1.recording.Video(cam1.maskframe)            
            cam1.showLiveImage()
